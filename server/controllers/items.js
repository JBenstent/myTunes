  ...
  uploadimage: function(request, response){
    ...
    User.findOne({_id:request.session.userID}, function(err, user){
      ...
      if(err){
        ...
        console.log('THIS IS REQUEST.FILE',request.file);

        // if (request.file.mimetype == 'image/jpeg' || request.file.mimetype == 'png') {
        ...
        user.save(function(err, user){
          if (err){
            ...
            // fs.rename('/uploads/'+ request.file.filename, '/uploads/images/' + request.file.filename, function(err){
            //   if(err){
